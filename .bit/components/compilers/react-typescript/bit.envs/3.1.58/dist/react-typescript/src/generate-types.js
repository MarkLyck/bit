...
exports.getImageType = exports.getSVGType = exports.getGenericStyle = exports.generateTypes = void 0;
const recursive_readdir_1 = __importDefault(require("recursive-readdir"));
const fs_extra_1 = __importDefault(require("fs-extra"));
function generateTypes(_dir) {
    return __awaiter(this, void 0, void 0, function* () {
        const strategies = getStrategies();
        const dir = yield recursive_readdir_1.default(_dir, ['node_modules', 'dist', '.dependencies']);
        const filesToCreate = dir.filter(file => Object.keys(strategies).some(extension => file.endsWith(`.${extension}`)));
        return yield Promise.all(filesToCreate.map(file => {
